  ...
  try {
    ...
    if (role !== "ADMIN" && role !== "SUPER_ADMIN") {
      return NextResponse.json(
        {
          success: false,
          error: "Somente administradores podem enviar logo e favicon.",
        },
        { status: 403 },
      );
    }
      ...
      return NextResponse.json(
        {
          success: false,
          error:
            "Formato inválido. Use PNG, JPG, WEBP, SVG ou ICO para branding.",
        },
        { status: 400 },
      );
    }
      ...
      return NextResponse.json(
        {
          success: false,
          error:
            "Não foi possível processar a imagem enviada. Use PNG, JPG, WEBP ou SVG.",
        },
        { status: 400 },
      );
    }
    ...
    return NextResponse.json(
      {
        success: false,
        error: "Erro interno ao fazer upload do branding.",
      },
      { status: 500 },
    );
  }
